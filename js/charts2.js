...
// deep copy
const showingSeries_chart2 = JSON.parse(JSON.stringify(series_chart2));
...
const levels_chart2 = ["קל", "בינוני", "קשה"];
const seriesMapping_chart2 = {
  קל: [true, showingSeries_chart2[0]],
  בינוני: [true, showingSeries_chart2[1]],
  קשה: [true, showingSeries_chart2[2]],
};

const seriesByTimeSpan_chart2 = {
  0.5: series_chart2, // 1 month
  1: series_3_chart2, // 3 months
  6: series_6_chart2, // 6 months
  12: series_12_chart2, // 1 year
  18: series_18_chart2, // 2 years
};
...
const changeSeriesTimeSpan_chart2 = function (timeSpan) {
  for (let i = 0; i < levels_chart2.length; i++) {
    seriesMapping_chart2[levels_chart2[i]][1] =
      seriesByTimeSpan_chart2[timeSpan][i];
  }
  chart.yAxis[0].update({
    tickPositions: tickPositionsByTimeSpan_chart2[timeSpan],
  });
  chart.xAxis[0].update({
    tickInterval: tickIntervalByTimeSpan_chart2[timeSpan],
    labels: {
      formatter: function () {
...
function handleTimeSpanChange_chart2(checked, value) {
  if (checked) {
    changeSeriesTimeSpan_chart2(value);
...
function updateChartSeries_chart2() {
  chart_2.series.forEach((s) => s.remove());
  chart_2.series.forEach((s) => s.remove());

  openG1TimeSelect_chart2.textContent = "";
  for (var j = 0; j < levels_chart2.length; j++) {
    if (seriesMapping_chart2[levels_chart2[j]][0]) {
      chart_2.addSeries(seriesMapping_chart2[levels_chart2[j]][1]);
      openG1TimeSelect_chart2.textContent += levels_chart2[j];
      if (j < levels_chart2.length - 1)
        openG1TimeSelect_chart2.textContent += ", ";
    }
  }
}
...
function createLevelCheckbox_chart2(level, index, list) {
  ...
  checkbox.id = level;
  checkbox.checked = seriesMapping_chart2[level][0];
...
g1okbutton_chart2.addEventListener("click", function () {
  ...
  if (selectedRadio) {
    ...
    handleTimeSpanChange_chart2(true, value); // Assuming you want to set it as checked
...
openG1TimeSelect_chart2.addEventListener("click", function () {
  createGraphTimeSpanSelect_chart2(select_time_chart2); // no need
